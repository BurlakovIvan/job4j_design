...
--объявляем курсор, с возможностью прокрутки
declare cursor_products scroll cursor for select * from products;

--передвигаем курсор на 20 строк вперед
move forward 20 from cursor_products;

--начинаем двигаться по курсору в обратную сторону
fetch prior from cursor_products;
fetch prior from cursor_products;
fetch prior from cursor_products;
fetch backward 15 from cursor_products;
fetch prior from cursor_products;
